...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    /**
     * If shadow_view size is set to a value above max shadow_view, we print a warning
     */
    ...
    public ShadowDrawableWrapper(Context context, Drawable content, float radius,
        ...
        mShadowStartColor = ContextCompat.getColor(context, R.color.shadow);
        mShadowMiddleColor = ContextCompat.getColor(context, R.color.shadow);
        mShadowEndColor = ContextCompat.getColor(context, R.color.shadow);
